...
$P_t' = P_t Q$ and premultiply it by any distribution $\psi_0$ to get the
...
$P_t' = Q P_t$ and postmultiply it by any vector $h$ to get 
...
We can then premultiply it by $\psi_0 \in \dD$ to get $\psi_t' = \psi_t
